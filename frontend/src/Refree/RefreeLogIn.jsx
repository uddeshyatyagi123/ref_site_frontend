  ...
  return (
    <section className="min-h-screen grid place-content-center p-8">
      <div className="w-full flex flex-col h-full gap-12">
        <div>
          <h1 className="sm:text-[3em] text-[1.5em] text-center font-bold">
            Welcome back to your Journey!
          </h1>
          <p className="text-center font-semibold sm:text-[1.5em] text-[1em]">
            Login with your data that you entered while registration
          </p>
        </div>
        <form onSubmit={handleSubmit(Submitdata)}>
          ...
          <div className="flex flex-col gap-4 justify-center items-center">
            <p className="font-bold text-lg">Sign in with</p>
