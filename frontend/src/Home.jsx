...
const HomePage = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-3xl font-extrabold mb-4 text-gray-800">Welcome to Your Web App</h1>
        <p className="text-gray-600 mb-6">
          Choose your role below to get started with an amazing learning experience.
        </p>
        <motion.div
